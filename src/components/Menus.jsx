  ...
  return (
    <div>
      <Header/>
        ...
        {
          !loading ?       <FilteredDishes  categoryData={categoryData} allMenus={menu} singleDish={singleDish} /> :             <h1 className=" m-5 mt-5 p-5 text-center text-danger fw-bold">Loading...</h1>
